...
describe "TimeSignature" do
  ...
  it "should not have a :reference_duration on creation" do
    @ts1.reference_duration.should be_nil
  end
  ...
  it "should have a value for :reference_duration after to_s is called" do
    @ts1.reference_duration.should == Note.new(c4, 4)
    @ts2.reference_duration.should == Note.new(d3, 1)
  end
